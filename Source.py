...
ctypes.windll.kernel32.SetConsoleTitleW('8ys Selfbot | Version 1.0 | Loading...')
...
Reluctant = commands.Bot(description='8ys Selfbot',intents=intents,command_prefix=prefix ,self_bot=True)
...
def startprint():
    ...
    print(f'''{Fore.RED}
             ...
             {colorama.Fore.WHITE}─────────────────────────{colorama.Fore.RED}─────────────────────────
                           {colorama.Fore.WHITE}Created by [{colorama.Fore.RED}8ys{colorama.Fore.WHITE}]
             ...
             {colorama.Fore.WHITE}─────────────────────────{colorama.Fore.RED}─────────────────────────
    ''' + Fore.WHITE)
    ctypes.windll.kernel32.SetConsoleTitleW(f'8ys | Version 1.0  | Logged As: {Reluctant.user.name}')
